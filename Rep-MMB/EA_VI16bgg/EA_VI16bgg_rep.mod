...
rho_dy    = 0.06;     % Response to change in the output gap

rho_a     = 0.87;     % Persistence of technological shock
rho_k     = 0.99;
rho_g     = 0.92;
rho_x     = 0.97;     % Persistence of shock to K
rho_ri    = 0.25;
rho_p     = 0.81;
rho_w     = 0.59;
...
% 12 % Phillips Curve: Employment (OMITTED)
...
zkf=  (wf)+lf-kf(-1)-uf ;
% 5
if = (1/(1+beta))* (if(-1) + beta*if(+1)+(1/ksi)*(qf +eps_x))  ;
% 13a 
...
var e_g; stderr 1.0;       %1.46;
var e_x; stderr 1.0;       %2.33;
var e_r; stderr 1.0;       %0.11;
var e_p; stderr 1.0;       %0.07;
var e_w; stderr 1.0;       %0.12;
end;
