...
%Last edited: 14/03/04 by A.H�ser and M.Kontny
...
varchi          = 0;
s_c             = 0.7;
s_s             = 0.6179;        //output share of type s consumption
s_b             = 0.7821;        //output share of type b consumption
mu_p            = theta / (theta-1) ;
sigma_bar       = 6.25;
...
eta             = (1/4) *(1+omega_bar)/omega_bar +1; //implies a spread elasticity of debt of (1/4)
